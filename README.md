...
Based on the [neuroglancer_mrc.py gist](https://gist.github.com/kephale/59a255383e9e1f5f096dedf657a5a091) by [@kephale](https://github.com/kephale). This repo adds [pixi](https://pixi.sh) dependency management.
